  ...
  <table style="width:100%;max-width:1000px;border-collapse:collapse;">
    <tr>
      <td style="padding:12px 16px;vertical-align:top;">
        <p style="margin:0 0 4px 0;">Ishanka Hirushan</p>
        <p style="margin:0 0 4px 0;">CTO at AXSYNTHEGROUP</p>
        <p style="margin:0;">BSc (Hons) Computer Engineering Undergraduate</p>  
      </td>
